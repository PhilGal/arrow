...
Option.monadError()
// arrow.core.Instance_arrow_instances_OptionMonadErrorInstanceKt$monadError$1@45d12671
```

```kotlin
Try.monadError()
// arrow.core.Instance_arrow_instances_TryMonadErrorInstanceKt$monadError$1@4942cabd
```

```kotlin
Either.monadError<NukeException>()
// arrow.core.Instance_arrow_instances_EitherMonadErrorInstanceKt$monadError$1@529e7f5d
```
